...
Connect${arg_watch_color}
    [Tags]               smoke
    Timeout 20s
    Access Landingpage     GB/Connect${arg_watch_color}
    ...
    # # Wait For Elements State     xpath=//div[@class='ajs-header'][contains(.,'Promotional Bundle')]    visible       30 
    # Get Text        xpath=//div[@class='ajs-content'][contains(.,'You are buying a Moochies Promotional Bundle! The discounted price will be shown on Paymet Step.')]      *=      You are buying a Moochies Promotional Bundle! The discounted price will be shown on Paymet Step.
...
Connect${arg_watch_color}BlueGeometric
    [Tags]               smoke
    Timeout 20s
    Access Landingpage     GB/Connect${arg_watch_color}BlueGeometric
...
Connect${arg_watch_color}CurlingCobra
    ...
    Timeout 20s
    Access Landingpage     GB/Connect${arg_watch_color}CurlingCobra
...
Connect${arg_watch_color}Cat
    ...
    Timeout 20s
    Access Landingpage     GB/Connect${arg_watch_color}CuteCats
...
Connect${arg_watch_color}DinoBand
    ...
    Timeout 20s
    Access Landingpage     GB/Connect${arg_watch_color}DinoBand
...
Connect${arg_watch_color}DonutWorry
    ...
    Timeout 20s
    Access Landingpage     GB/Connect${arg_watch_color}DonutWorry
...
Connect${arg_watch_color}Graffiti
    ...
    Timeout 20s
    Access Landingpage     GB/Connect${arg_watch_color}Graffiti
...
Connect${arg_watch_color}Love
    ...
    Timeout 20s
    Access Landingpage     GB/Connect${arg_watch_color}Love
...
Connect${arg_watch_color}Monster
    ...
    Timeout 20s
    Access Landingpage     GB/Connect${arg_watch_color}Monster
...
Connect${arg_watch_color}PinkGeometric
    ...
    Timeout 20s
    Access Landingpage     GB/Connect${arg_watch_color}PinkGeometric
