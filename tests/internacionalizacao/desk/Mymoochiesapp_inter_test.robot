...
Test Setup          Accsses    ${locale}    MyMoochiesApp
...
8.1-Validate content - AnyHelp
    ...
    #Paragraph Every child deserves a childhood of fun
    Validate content, JSON    id=blue  ${DIC_ANYHELP.card03.textTop}
    #Paragraph Every child deserves a childhood of fun
    Validate content, JSON    id=blue    ${DIC_ANYHELP.card03.textBottom}
    #Paragraph Every child deserves a childhood of fun
    Validate content, JSON    id=purple     ${DIC_ANYHELP.card02.textTop}
    #Paragraph Every child deserves a childhood of fun
    Validate content, JSON    id=purple   ${DIC_ANYHELP.card02.textBottom}
     #Paragraph Every child deserves a childhood of fun
