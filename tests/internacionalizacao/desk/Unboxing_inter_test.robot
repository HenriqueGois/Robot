...
Test Setup          Accsses    ${locale}    Unboxing
...
8.1-Validate content - GiveThemFreedom
    ...
    [Tags]    content
    Search element    xpath=//h1[contains(@id,'OpenYourMoochiesTitle_Desktop')]/..
    Log    Dicionário: ${DIC_OPENING}
    Sleep    2s
    #Title Giving Them Freedom...
    Validate content, JSON    id=OpenYourMoochiesTitle_Desktop    ${DIC_OPENING["title"]}
