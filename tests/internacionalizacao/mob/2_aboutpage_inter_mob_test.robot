...
Accsses
    ...
    New Context    &{device}
    New Page    https://kids-website-homolog.vercel.app/${locale}/Charity
    Sleep    2s
...
1-Validate content - FeaturesDesigned
    ...
    Validate content, JSON    xpath=//h1[@id='AbooutTextTitle']    ${DIC_TEXT["title"]}
    #Paragraph Moochies is on a mission to keep...
    Validate content, JSON    xpath=//p[@id='AbooutTextParagraph1']    ${DIC_TEXT["p1"]}
    #Paragraph With GPS tracking so you’ll know where they are....
    Validate content, JSON    xpath=//p[@id='AbooutTextParagraph2']    ${DIC_TEXT["p2"]}
    #Paragraph Every child deserves a childhood of fun
    Validate content, JSON    xpath=//p[@id='AbooutTextParagraph3']    ${DIC_TEXT["p3"]}
    #Paragraph Every child deserves a childhood of fun
    Validate content, JSON    xpath=//p[@id='AbooutTextParagraph4']    ${DIC_TEXT["p4"]}
    #Paragraph Every child deserves a childhood of fun
    Validate content, JSON    xpath=//p[@id='AbooutTextParagraph5']    ${DIC_TEXT["p5"]}
...
3-Validate content - Team
    ...
    [Tags]    content
    Sleep    2s
    Search element    xpath=//h1[@id='TeamTitle']/..
    Log    Dicionário: ${DIC_TEAM}
    Sleep    2s
    #Title Make Your Moochies Your Own
    Validate content, JSON    xpath=//h1[@id='TeamTitle']    ${DIC_TEAM["title"]}
...
3.14-Validate content - Team - TAMMY
 ...
 3.17-Validate content - Team - RACHEL
    #Text Every child is unique, with their own style, personality and tastes...
    Sleep    2s
    Validate content, JSON    id=TeamNameRachel    Rachel
    #Link
